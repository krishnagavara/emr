                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Collection Report</a>
                                            </li>
                                            ...
                                            <select class="form-control select2" name="patient_id" id="patient_id">
                                                ...
                                                <?php if($getpatient)
                                                {
                                                  foreach ($getpatient as $data) {
                                                    ?>
                                                      <option value="<?php print $data['patient_registration_id']; ?>"><?php print $data['pname']; ?></option>
                                                    <?php
                                                  }
                                                } ?>
                                            </select>
...
$.fn.dataTable.ext.errMode = 'none';
        $("#overlay").fadeIn(300);
        saveurl="Sales_collection_report/getsummary";
         $.ajax({
            type: "POST",
            url: saveurl,
            dataType: "json",
...
$.fn.dataTable.ext.errMode = 'none';
        $("#overlay").fadeIn(300);
        saveurl="Sales_collection_report/getdetailed";
         $.ajax({
            type: "POST",
            url: saveurl,
            dataType: "json",

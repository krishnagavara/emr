...
class Doctors_registration_model extends CI_Model{
 public function __construct()
       ...
       function ajax_call($requestData)
  {
    ...
    $sql = "SELECT doctors_registration_id,name,mobileno,specialist,description,if(status=1,'Active','Deactive') as status";
    $sql.=" FROM doctors_registration where office_id=$office_id ";
